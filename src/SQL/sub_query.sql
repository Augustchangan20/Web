-- 建测试库和表
create database sub_query charset utf8mb4;
use sub_query;
...
--找到公司中，和这个人姓名相同并且工资相同的人
insert into employee (depart_id, name, salary) values (4,'郭靖',17000),(4,'郭靖',17000),(5,'郭靖',6000);
select *from employee where (name,salary) = (select name,salary from employee where id = 7);
